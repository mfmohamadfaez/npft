...
//        JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, new JREmptyDataSource());
 ...
 @RequestMapping(value = {"/editParticipantDetails/{pid}"}, method = RequestMethod.GET)
    public String editParticipantDetails(@PathVariable("pid") int pid, Model model) {
        ...
        return "editParticipantDetails";
    }

    @RequestMapping(value = {"/deleteParticipantDetails/{pid}"}, method = RequestMethod.GET)
    public @ResponseBody String deleteParticipantDetails(@PathVariable("pid") String pid) {
        participantService.deleteParticipant(Integer.parseInt(pid));
        return "true";
    }
