...
<head>
    ...
    <style>
        ...
        .banner-sec{background:url("${pageContext.request.contextPath}/resources/images/NPFTWORD3.png")  no-repeat left bottom; background-size:cover; min-height:500px; border-radius: 0 10px 10px 0; padding<div class="carousel-caption d-none d-md-block">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 login-sec">
                ...
                <form:form class="login-form" action="/processLoginForm" modelAttribute="identity" method="post">
            ...
            <div class="col-md-8 banner-sec">
                ...
                <%--<img class="d-block img-fluid" src="/resources/images/NPFTWORD3.png" alt="First slide">--%>
                <%--&lt;%&ndash;<div class="carousel-caption d-none d-md-block">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="banner-text">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<h2>This is Heaven</h2>&ndash;%&gt;--%>
